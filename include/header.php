...
<body class="hold-transition sidebar-mini" id="main-body">
             ...
             with font-awesome or any other icon font library -->
              ...
              <li class="nav-item has-treeview">
                <a href="#" class="nav-link">
                  ...
                  <p> &nbsp;Bảo vệ hệ thống tệp tin<i class="fa fa-angle-left right"></i></p>
                </a>
              ...
              <li class="nav-item has-treeview">
                <a href="#" class="nav-link">
                  <i class="fa fa-archive"></i>
                  <p> &nbsp;Quản lý tường lửa<i class="fa fa-angle-left right"></i></p>
                </a>
                <ul class="nav nav-treeview">
          ...
          <a href="app.php" class="nav-link">
            <p><i class="fa fa-bookmark" aria-hidden="true"></i> &nbsp;Quản lý ứng dụng</i></p>
              ...
              <li class="nav-item has-treeview">
                <a href="#" class="nav-link">
                  <i class="fa fa-archive"></i>
                  <p> &nbsp;Kiểm thử và đánh giá<i class="fa fa-angle-left right"></i></p>
                </a>
                <ul class="nav nav-treeview">
 ...
 -->
              ...
              <li class="nav-item has-treeview">
                <a href="#" class="nav-link">
                  <i class="fa fa-archive"></i>
                  <p> &nbsp;Rà soát mã độc<i class="fa fa-angle-left right"></i></p>
                </a>
                <ul class="nav nav-treeview">
          ...
          <a href="file_secure.php" class="nav-link">
           <p><i class="fa fa-circle-o nav-ico" aria-hidden="true"></i> &nbsp; Báo cáo thống kê</p>
              ...
              <li class="nav-item has-treeview">
                <a href="#" class="nav-link">
                  <i class="fa fa-archive"></i>
                  <p> &nbsp;Quản lý ứng dụng <i class="fa fa-angle-left right"></i></p>
                </a>
                <ul class="nav nav-treeview">
          ...
          <a href="log.php" class="nav-link">
            <p><i class="fa fa-bookmark" aria-hidden="true"></i> &nbsp;Quản lý lưu nhật ký</i></p>
              ...
              <li class="nav-item has-treeview">
                <a href="#" class="nav-link">
                  <i class="fa fa-archive"></i>
                  <p> &nbsp; Tùy chọn hệ thống<i class="fa fa-angle-left right"></i></p>
                </a>
                <ul class="nav nav-treeview">
