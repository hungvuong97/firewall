...
<div class="row">
            ...
            <button id="button1" type="button" class="btn btn-add" onclick="encrype()" style="margin: 10px 10px 10px 0px;"><i class="fa fa-lock" aria-hidden="true"></i> Mã hóa</button>
             <button id="button1" type="button" class="btn btn-add" onclick="decrype()" style="margin: 10px 10px 10px 0px;"><i class="fa fa-unlock" aria-hidden="true"></i> Giải mã</button>
          </div>
            </div>
            <br><br>
                             </div></div>
